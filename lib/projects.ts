    ...
    tools: [
      {
        ...
        how: "A Claude Project preloaded with Cascade's brand voice, tone guidelines, and example marketing copy. Anyone on the team opens the project, describes what they need in plain language, and gets on-brand output, no briefing required.",
        tags: ["Claude"],
      },
      {
        ...
        blurb:
          "Written standards for visual identity, copy tone, and brand application.",
        how: "A three-part Notion doc covering visual identity standards, copy tone and voice guidelines, and a content examples bank. Built as a resource for scanning all outgoing content to ensure branding accuracy, so any team member could QA their own work without a review cycle.",
        tags: ["Notion", "Figma"],
      },
      {
        category: "Ops",
        ...
        how: "A Notion database with one row per major depositor. Fields: deposit history, preferred comms channel, conversation log, last-touch date, next action. Treated less like a CRM and more like a relationship journal.",
        tags: ["Notion"],
      },
      {
        category: "Ops",
        ...
        how: "A Claude skill that pulls from three sources: Granola meeting transcripts, Slack thread summaries, and the day's calendar. One command generates a structured Notion daily page with meeting prep, outstanding threads, and a task list. Turns context-gathering from a 20-minute morning ritual into a 30-second command.",
